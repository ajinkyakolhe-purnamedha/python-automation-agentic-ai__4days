...
def seed_products():
    ...
    return [
        ...
        Product(id=2, name="Mechanical Keyboard", category="Electronics", price=5499.0, in_stock=True, tags=["keyboard", "mech"]),
        Product(id=3, name="Steel Water Bottle", category="Home", price=899.0, in_stock=True, tags=["bottle", "steel"]),
        Product(id=4, name="Yoga Mat", category="Fitness", price=1299.0, in_stock=False, tags=["mat", "yoga"]),
        Product(id=5, name="Bluetooth Speaker", category="Electronics", price=2499.0, in_stock=True, tags=["speaker", "bt"]),
    ]
